...
const ScheduleChart = ({ objectives, contractSignDate, targetCompletionDate }) => {
...
export default function NewProposalPage({ projectData, onProposalCreated }: NewProposalPageProps) {
  const router = useRouter()
  const [activeStep, setActiveStep] = useState<"client" | "project" | "services" | "sign">("client")
  ...
  const [objectiveTimelines, setObjectiveTimelines] = useState<Record<string, number>>({
    assemble: 0,
    schematic: 0,
    development: 0,
    construction: 0,
  ...
  const toggleObjective = (objectiveId: string) => {
    setSelectedObjectives((prev) => {
      ...
      const newSelected = isSelected ? prev.filter((id) => id !== objectiveId) : [...prev, objectiveId]

      // Calculate new totals
      const newTotalCost = newSelected.reduce((sum, id) => sum + objectiveCosts[id], 0)
      const newTotalWeeks = newSelected.reduce((sum, id) => sum + objectiveTimelines[id], 0)
  ...
  const handleCostChange = (id: string, value: string) => {
    ...
    setObjectiveCosts((prev) => {
      ...
      const newTotalCost = selectedObjectives.reduce((sum, objId) => sum + newCosts[objId], 0)
      setTotalCost(newTotalCost)
  ...
  const handleTimelineChange = (id: string, value: string) => {
    ...
    setObjectiveTimelines((prev) => {
      ...
      const newTotalWeeks = selectedObjectives.reduce((sum, objId) => sum + newTimelines[objId], 0)
      setTotalWeeks(newTotalWeeks)
  ...
  const clearSignature = (ref: React.MutableRefObject<SignatureCanvas | null>) => {
    ref.current?.clear()
  }
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-between mt-2">
            <div className={`flex flex-col items-center ${activeStep === "client" ? "text-blue-600" : ""}`}>
              <div className={`w-4 h-4 rounded-full ${activeStep === "client" ? "bg-blue-600" : "bg-gray-300"}`}></div>
              <span className="text-xs mt-1">Client</span>
            </div>
            <div className={`flex flex-col items-center ${activeStep === "project" ? "text-blue-600" : ""}`}>
              <div
                className={`w-4 h-4 rounded-full ${activeStep === "project" ? "bg-blue-600" : progress >= 33 ? "bg-blue-600" : "bg-gray-300"}`}
              ></div>
              <span className="text-xs mt-1">Project</span>
            </div>
            <div className={`flex flex-col items-center ${activeStep === "services" ? "text-blue-600" : ""}`}>
              <div
                className={`w-4 h-4 rounded-full ${activeStep === "services" ? "bg-blue-600" : progress >= 66 ? "bg-blue-600" : "bg-gray-300"}`}
              ></div>
              <span className="text-xs mt-1">Services</span>
            </div>
            <div className={`flex flex-col items-center ${activeStep === "sign" ? "text-blue-600" : ""}`}>
              <div
                className={`w-4 h-4 rounded-full ${activeStep === "sign" ? "bg-blue-600" : progress >= 100 ? "bg-blue-600" : "bg-gray-300"}`}
              ></div>
        ...
        {activeStep === "client" && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h2 className="text-lg font-semibold mb-6 border-l-4 border-blue-600 pl-3">Client Information</h2>
            ...
            <div className="mb-6">
              ...
              <Select value={clientInfo.country} onValueChange={(value) => handleClientInfoChange("country", value)}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              ...
              <div>
                ...
                <Select value={clientInfo.state} onValueChange={(value) => handleClientInfoChange("state", value)}>
        ...
        {activeStep === "project" && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h2 className="text-lg font-semibold mb-6 border-l-4 border-blue-600 pl-3">Project Information</h2>
            ...
            <div className="mb-6">
              ...
              <Textarea
                ...
                onChange={(e) => handleProjectInfoChange("additionalContext", e.target.value)}
              />
              <p className="text-xs text-gray-500 mt-1">
            ...
            <div className="mb-6">
              <Label className="flex items-center gap-2" htmlFor="googleDriveLink">
                <svg
              ...
              <Input
                ...
                onChange={(e) => handleProjectInfoChange("googleDriveLink", e.target.value)}
              />
              <p className="text-xs text-gray-500 mt-1">Add a Google Drive folder link containing project documents</p>
            </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleProjectInfoChange("sameAsMailingAddress", checked === true)}
                  />
              ...
              <div className="mt-4">
                ...
                <Input
                  ...
                  onChange={(e) => handleProjectInfoChange("streetAddress", e.target.value)}
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
                ...
                <div>
                  ...
                  <Select value={projectInfo.state} onValueChange={(value) => handleProjectInfoChange("state", value)}>
            ...
            <div className="mb-6">
              ...
              <Select value={projectInfo.country} onValueChange={(value) => handleProjectInfoChange("country", value)}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) => handleProjectInfoChange("serviceType", value)}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleProjectInfoChange("squareFootage", e.target.value)}
                />
              </div>
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) => handleProjectInfoChange("budgetRange", value)}
                >
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) => handleProjectInfoChange("timeline", value)}
                >
        ...
        {activeStep === "services" && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-lg font-semibold border-l-4 border-blue-600 pl-3">Scope of Services</h2>
              <div className="flex items-center">
                <Button variant="outline" size="sm" onClick={() => {}}>
                  + Add Objective
                </Button>
                <span className="ml-4 text-sm text-gray-500">Selected: {selectedObjectives.length} / 8</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2">
                {objectives.map((objective) => (
                  <div key={objective.id} className="mb-4 border rounded-md overflow-hidden">
                    <div className="flex items-center p-3 bg-gray-50">
                      <Checkbox
                        ...
                        className="mr-3"
                      />
                      <label htmlFor={objective.id} className="font-medium cursor-pointer flex-grow">
                        {objective.label}
                      </label>
                      <div className="flex items-center space-x-2">
                        <div className="flex items-center">
                          ...
                          <Input
                            ...
                            onChange={(e) => handleCostChange(objective.id, e.target.value)}
                        ...
                        <div className="flex items-center">
                          <Input
                            ...
                            onChange={(e) => handleTimelineChange(objective.id, e.target.value)}
                ...
                {selectedObjectives.length === 0 && (
                  <div className="flex flex-col items-center justify-center p-12 text-center border-2 border-dashed rounded-md bg-gray-50">
                    ...
                    <p className="text-gray-500 mb-4">
                      Please select the services you'd like to include in your proposal.
                    </p>
              ...
              <div>
                <div className="border rounded-md p-4 mb-4">
                  <h3 className="font-medium text-lg mb-4 border-l-4 border-amber-500 pl-2">Project Summary</h3>
                  ...
                  <div className="mb-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Button variant="outline" size="sm" onClick={() => setShowAddCredit(!showAddCredit)}>
                        + Add Credit
                      </Button>
                    </div>
                    ...
                    {credits.length > 0 && (
                      <div className="space-y-2 mb-3">
                        {credits.map((credit) => (
                          <div key={credit.id} className="flex items-center justify-between bg-gray-50 p-2 rounded-md">
                            <div>
                              <p className="text-sm font-medium">{credit.description || "Credit"}</p>
                              <p className="text-xs text-gray-500">
                                {credit.type === "dollar" ? `${credit.amount.toLocaleString()}` : `${credit.amount}%`}
                              </p>
                            </div>
                            <Button
                              variant="ghost"
                              size="sm"
                              onClick={() => setCredits(credits.filter((c) => c.id !== credit.id))}
                            >
                    ...
                    {showAddCredit && (
                      <div className="border p-3 rounded-md mb-3">
                        <div className="grid grid-cols-2 gap-2 mb-2">
                          <div>
                            ...
                            <Select
                              ...
                              onValueChange={(value) =>
                                setNewCredit({ ...newCredit, type: value as "dollar" | "percentage" })
                              }
                            >
                          ...
                          <div>
                            ...
                            <div className="flex items-center">
                              {newCredit.type === "dollar" && <span className="text-sm mr-1">$</span>}
                              <Input
                                id="creditAmount"
                                type="number"
                                min="0"
                              ...
                              />
                              {newCredit.type === "percentage" && <span className="text-sm ml-1">%</span>}
                            </div>
                          </div>
                        </div>
                        <div className="mb-2">
                          <Label htmlFor="creditDescription" className="text-xs">
                            Description
                          </Label>
                          <Input
                        ...
                        <div className="flex justify-end space-x-2">
                          <Button variant="outline" size="sm" onClick={() => setShowAddCredit(false)}>
                            Cancel
                          </Button>
                          <Button
                            size="sm"
                            onClick={() => {
                              setCredits([...credits, { ...newCredit, id: Date.now().toString() }])
                              setNewCredit({ type: "dollar", amount: 0, description: "" })
                  ...
                  <div className="border-t pt-4 mb-4">
                    ...
                    <p className="text-xl font-medium text-green-600">${finalCost.toLocaleString()}</p>
                    {credits.length > 0 ? (
                      <p className="text-xs text-gray-500">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-500 mt-1">Client will pay the full amount upfront</p>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-8">
                ...
                <p>
                  {clientInfo.firstName} {clientInfo.lastName} - {projectInfo.streetAddress}
                </p>
              </div>
              ...
              <div className="mb-8">
                ...
                <p className="mb-4">
                  Architecture Simple is pleased to present this design services proposal for the proposed{" "}
                  {projectInfo.serviceType} of a
                  {projectInfo.projectDescription ? ` (${projectInfo.projectDescription})` : ""} at{" "}
                  {projectInfo.streetAddress}.
                </p>
              </div>

              <div className="mb-8">
                <h3 className="text-xl font-semibold mb-4">Project Understanding</h3>
                <p className="mb-4">
                  The project is located in {projectInfo.city}, {projectInfo.state}.
                </p>
                {projectInfo.projectDescription && <p className="mb-4">{projectInfo.projectDescription}</p>}
                {projectInfo.additionalContext && <p className="mb-4">{projectInfo.additionalContext}</p>}
              </div>

              <div className="mb-8">
                <h3 className="text-xl font-semibold mb-4">Article 1 - Definitions</h3>
                <p className="mb-4">
                  To establish a clear understanding, the following terms are defined for use throughout this Agreement:
                </p>
                <p className="mb-2">
                  <strong>"Architect"</strong> refers to Architecture Simple, represented by Eric Rivera, AIA, who will
                  provide professional architectural services as detailed in this Agreement.
                </p>
                <p className="mb-2">
                  <strong>"Owner"</strong> refers to Client's Name, the individual or entity who is entering into this
                  Agreement with the Architect to develop the Project.
                </p>
                <p className="mb-2">
                  <strong>"Project"</strong> refers to the construction of a residential building at Project Address,
                  City, State ZIP Code, as more specifically described in the Proposal attached hereto.
                </p>
                <p className="mb-2">
                  <strong>"Work"</strong> refers to all architectural, engineering, and related professional services
                  required for the design, development, and documentation of the Project, as set forth in the Scope of
                  Services.
                </p>
                <p className="mb-2">
                  <strong>"Design Documents" (DDs)</strong> refers to the completed Schematic Design and Design
                  Development documents, including all drawings, specifications, and other materials prepared by the
                  Architect as part of the development of the Project.
                </p>
                <p className="mb-2">
                  <strong>"Construction Documents" (CDs)</strong> refers to the completed set of final documents that
                  provide the necessary details for construction and permitting, including plans, specifications, and
                  other materials, prepared by the Architect.
                </p>
                <p className="mb-2">
                  <strong>"Bidding Documents"</strong> refers to the final, completed{" "}
                  <strong>"Bidding Documents"</strong> refers to the final, completed Construction Documents and any
                  related documents issued to contractors or bidders.
                </p>
                <p className="mb-2">
                  <strong>"Substantial Completion"</strong> means the point in time when the Project is sufficiently
                  complete in accordance with the Contract Documents, allowing the Owner to occupy or utilize the
                  building for its intended use.
                </p>
                <p className="mb-2">
                  <strong>"Completion"</strong> refers to the final completion of all construction work, including punch
                  list items and final inspections, after which the Project is fully delivered to the Owner.
                </p>
              </div>

              <div className="mb-8">
                <h3 className="text-xl font-semibold mb-4">Article 2 - Scope of Services</h3>
                <p className="mb-4">
                ...
                {selectedObjectives.length > 0 ? (
                  ...
                  <p className="italic text-gray-500">No services have been selected.</p>
                )}
              </div>

              <div className="mb-8">
                <h3 className="text-xl font-semibold mb-4">Article 3 - Payment Terms</h3>
                <h4 className="font-medium mb-2">3.1 Payment Structure</h4>
                <p className="mb-4">
                  The total fee for the services provided under this Agreement shall be (
                  {paymentMethod === "lumpSum" ? "lump sum" : "installments upon task completion"}) for the amount of $
                  {totalCost.toLocaleString()}, as follows:
                </p>

                <table className="w-full mb-4 border-collapse">
                  <thead>
                    <tr className="bg-gray-100">
                      <th className="border p-2 text-left">PROFESSIONAL SERVICES FEE</th>
                    ...
                    {selectedObjectives.map((id) => {
                      ...
                      return objective ? (
                        <tr key={id}>
                          ...
                          <td className="border p-2 text-right">${objectiveCosts[id].toLocaleString()}</td>
                        </tr>
                      ) : null
                    })}
                    {selectedObjectives.length === 0 && (
                        ...
                        {credits.map((credit) => (
                          <tr key={credit.id}>
                            <td className="border p-2 pl-4 text-sm">
                              {credit.description || (credit.type === "dollar" ? "Dollar Credit" : "Percentage Credit")}
                            </td>
                            <td className="border p-2 text-right text-green-600">
                              -
                              {credit.type === "dollar"
                                ? `${credit.amount.toLocaleString()}`
                                : `${((totalCost * credit.amount) / 100).toLocaleString()} (${credit.amount}%)`}
                            </td>
                          </tr>
                        ))}
                      </>
                  ...
                  <tfoot>
                    <tr className="bg-gray-100">
                      ...
                      <td className="border p-2 text-right font-bold text-lg">${finalCost.toLocaleString()}</td>
                    </tr>
                  </tfoot>
                </table>
                ...
                {paymentMethod === "lumpSum" ? (
                  <>
                    <p className="mb-4">The Owner will pay the full amount upon execution of this Agreement.</p>
                    <ul className="list-disc pl-6 mb-4">
                      <li>
                        <strong>Lump Sum Payment:</strong> The Owner will pay the full lump sum of $
                        {finalCost.toLocaleString()} at the beginning of the Project, upon execution of this Agreement.
                      </li>
                    </ul>
                  </>
                ) : (
                  <>
                    <p className="mb-4">
                      The Owner will pay in installments based on the completion of each objective.
                    </p>
                    <table className="w-full mb-4 border-collapse">
                      <thead>
                        <tr className="bg-gray-100">
                          <th className="border p-2 text-left">Objective</th>
                          <th className="border p-2 text-right">Payment Amount</th>
                        ...
                        {selectedObjectives.map((id) => {
                          ...
                          return objective ? (
                            <tr key={id}>
                              <td className="border p-2">{objective.label}</td>
                              <td className="border p-2 text-right">${objectiveCosts[id].toLocaleString()}</td>
                              <td className="border p-2 text-right">{objectiveTimelines[id]} weeks</td>
                            </tr>
                          ) : null
                        })}
                      </tbody>
                    ...
                    <p className="mb-4">
                      ...
                      {Math.round(finalCost * 0.25).toLocaleString()}) is due upon execution of this Agreement.
                    </p>
                    <p className="mb-4">
                      <strong>Remaining Payments:</strong> The remaining balance will be invoiced upon completion of
                ...
                <p className="mb-4">
                  All invoices are due within 30 days of receipt. Late payments are subject to a 1.5% monthly interest
                  charge.
                </p>
              </div>

              <div className="mb-8">
                <h3 className="text-xl font-semibold mb-4">Article 4 - Additional Services</h3>
                <p className="mb-4">
                  Additional services not specified in the Scope of Services are available upon request and can be
                  provided on a time and materials basis, according to the Fee Schedule shown in Exhibit A.
                </p>
              </div>

              <div className="mb-8">
                <h3 className="text-xl font-semibold mb-4">Article 5 - Owner's Responsibilities</h3>
                <p className="mb-4">The Owner agrees to:</p>
                <ul className="list-disc pl-6 mb-4">
                  <li className="mb-2">
                    Provide all necessary documents, approvals, and access to the site as required for the Architect to
                    perform the Work.
                  </li>
                  <li className="mb-2">Secure all necessary approvals and permits from the local AHJ.</li>
                  <li className="mb-2">
                    Notify the Architect of any changes in the scope of services or design and provide prompt written
                    authorization for any additional services.
                  </li>
                </ul>
              </div>
              ...
              <div className="mb-8">
                ...
                <p className="mb-2">Project Name: {projectInfo.projectName || "[Project Name]"}</p>
              ...
              <div className="mb-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="border border-dashed p-4 mb-4 h-32 flex items-center justify-center">
                    <p className="text-gray-400">Client's signature required</p>
                  </div>
                  <div>
                    <SignatureCanvas
                ...
                <div>
                  ...
                  <div className="border border-dashed p-4 mb-4 h-32 flex items-center justify-center">
                    <p className="text-gray-400">Architect's signature required</p>
                  </div>
                  <div>
                    <SignatureCanvas
              ...
              <div className="mb-8">
                <h3 className="text-xl font-semibold mb-4">Article 6 - Schedule + Contact Information</h3>
                <p className="mb-4">
                  Architecture Simple will provide architectural services as outlined in this proposal. The estimated
                  timeline for completion of all active objectives is {totalWeeks} weeks. Upon client signature, the
                  official contract start date will be set to the following Monday, and the project timeline will
                  commence from that date. This approach ensures clear milestone tracking and efficient project
                  scheduling from the beginning of the work week.
                </p>

                <h4 className="font-medium mb-2">Schedule</h4>
                <p className="mb-4">
                  Architecture Simple is prepared to commence design efforts immediately upon acceptance of this
                  proposal and the issuance of a written notice to proceed.
                </p>
              ...
              <div className="mb-8">
                <h3 className="text-xl font-semibold mb-4">Exhibit A: Professional Services Fee Schedule</h3>
