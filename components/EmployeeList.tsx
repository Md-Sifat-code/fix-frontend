...
import { ArrowUpDown, Pencil, Info, Trash2 } from "lucide-react";
                    ...
                    <DialogContent className="sm:max-w-[700px]">
                      ...
                      <Tabs defaultValue="basic-info" className="space-y-4">
                        ...
                        <TabsContent value="payroll" className="space-y-4">
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                              ...
                              <Select
                                value={
                                  editingEmployee?.payFrequency || "biweekly"
                                }
                                onValueChange={(value) =>
                                  setEditingEmployee({
                                    ...editingEmployee!,
                          ...
                          <div className="space-y-2 mt-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              <div className="space-y-2">
                                <Label htmlFor="dentalInsurance">
                                  Dental Insurance ($ per pay period)
                                </Label>
                                <Input
                                  id="dentalInsurance"
                                  value={
                              ...
                              <div className="space-y-2">
                                <Label htmlFor="visionInsurance">
                                  Vision Insurance ($ per pay period)
                                </Label>
                                <Input
                                  id="visionInsurance"
                                  value={
                        ...
                        <TabsContent value="tax" className="space-y-4">
                          <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                              <Label htmlFor="federalTaxWithholding">
                            ...
                            <div className="space-y-2">
                              <Label htmlFor="stateTaxWithholding">
                            ...
                            <div className="space-y-2">
                              ...
                              <Input
                                id="socialSecurity"
                                value={
                                  editingEmployee?.taxInfo?.socialSecurity || ""
                                }
                                onChange={(e) =>
                                  setEditingEmployee({
                                    ...editingEmployee!,
                            ...
                            <div className="flex items-start">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-blue-700 mt-1">
                                  ...
                                  {editingEmployee?.state || "Not set"})
                                  determines the state tax withholding rate.
                                  Different states have different tax rates and
                                  regulations.
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="space-y-4">
                            <div className="flex items-center justify-between">
                              <div className="space-y-0.5">
                                <Label htmlFor="studioAccess">
                                  Studio Access
                                </Label>
                                <p className="text-sm text-muted-foreground">
                                  Access to the main studio workspace
                                </p>
                              </div>
                              <Switch
                                id="studioAccess"
                            ...
                            <div className="flex items-center justify-between">
                              <div className="space-y-0.5">
                                <Label htmlFor="mediaAccess">
                                  Media Access
                                </Label>
                                <p className="text-sm text-muted-foreground">
                                  Access to media files, projects, and
                                  publications
                                </p>
                              </div>
                              <Switch
                            ...
                            <div className="flex items-center justify-between">
                              <div className="space-y-0.5">
                                <Label htmlFor="financialsAccess">
                                  Financials Access
                                </Label>
                                <p className="text-sm text-muted-foreground">
                                  Access to financial data, reports, and
                            ...
                            <div className="flex items-center justify-between">
                              <div className="space-y-0.5">
                                <Label htmlFor="projectAssignment">
                                  Project Assignment
                                </Label>
                                <p className="text-sm text-muted-foreground">
                            ...
                            <div className="flex items-center justify-between">
                              <div className="space-y-0.5">
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Read-only access to assigned areas without
                                  edit permissions
                                </p>
                              </div>
                              <Switch
                                id="viewOnly"
                                checked={
                                  editingEmployee?.accessPermissions?.viewOnly
                                }
                                onCheckedChange={(checked) =>
                                  setEditingEmployee({
                                    ...editingEmployee!,
